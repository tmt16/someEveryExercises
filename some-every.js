...
function hasOddNumber(arr) {
    ...
    //return/create some arr function
    return arr.some(function(value) {

        // return if value is not equal to 0 (using modulus operator )
        return (value % 2) !== 0
...
function hasOnlyOddNumbers(arr) {
    ...
    //create arr.every function with value as a parameter
    return arr.every(function(value) {

        // return if value is not equal to modulus operator (value % 2 === 0 )
        return (value % 2) !== 0;
    })
...
function hasNoDuplicates(arr) {
    ...
    // create arr.every function, which accepts value and index
    return arr.every(function(value, index) {

        // return if (not) index is not equal to indexOf value in the arr
...
function hasCertainKey(arr, key) {
    ...
    // create arr.some function
    return arr.every(function(value) {

        // return if key is present in each value of the obj 
        return key in value;
    });
}
...
function hasCertainValue(arr, key, searchValue) {
    ...
    // create arr.every function
    return arr.every(function(value) {

        // return if "key, searchValue" are contained in the array
